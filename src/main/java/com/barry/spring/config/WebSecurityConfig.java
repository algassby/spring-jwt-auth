 ...
 * 
 */
package com.barry.spring.config;
...
import com.barry.spring.filter.JWTAuthenticationFilter;
import com.barry.spring.filter.JWTLoginFilter;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(AuthenticationManagerBuilder auth) throws Exception {
		...
		System.out.println(" encoded password 123= "+encryptedPassword);
